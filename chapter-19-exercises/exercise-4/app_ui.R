...
intro_panel <- tabPanel(
  ...
  # text.
  p(
    "The diagram shows that the income growth for the", strong("poor"), 
    "and", strong("middle"), "class has been on a", em("slow"), "decline. For the",
    strong("upper"), "class, the income growth has been on a", em("steady"), "incline
    and as of late, it has been increasing", (em("rapidly.")
    )
  )
